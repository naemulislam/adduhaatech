							...
							<div class="card-spacer mt-n25">
								...
								<div class="row m-0">
									...
									<div class="col bg-light-primary px-6 py-8 rounded-xl mb-7">
										...
										<a href="" class="text-primary font-weight-bold font-size-h6 mt-2">Groups</a>
									</div>
								...
								<div class="row m-0">
									<div class="col bg-light-danger px-6 py-8 rounded-xl mr-7">
										...
										<a href="" class="text-danger font-weight-bold font-size-h6 mt-2">Online Admission Request </a>
									</div>
									<div class="col bg-light-success px-6 py-8 rounded-xl">
										...
										<a href="#" class="text-success font-weight-bold font-size-h6 mt-2">Parants</a>
									</div>
								</div>
								<!--end::Row-->
							</div>
