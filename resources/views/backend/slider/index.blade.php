...
@section('content')
                        ...
                        <tbody>
                            @foreach ($sliders as $slider)
                                <tr>
                                    ...
                                    <td>{{$slider->added_by}}</td>
                                    <td>{{$slider->order}}</td>
                                    <td>
                                        @if ($slider->status == 1)
                                            <a href="#" class="btn label label-lg label-light-success label-inline"
                                                data-toggle="modal"
                                                @if (Auth::user()->role == 'admin') data-target="#row_status_{{ $slider->id }}" @endif>
                                                Active</a>
                                    ...
                                    @if (Auth::user()->role == 'admin')
                                        <td class="d-flex">
                                            ...
                                            <a id="delete" href="{{ route('admin.slider.destroy', $slider->id) }}"
                                ...
                                <div class="modal fade" data-backdrop="static" id="row_status_{{ $slider->id }}"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form action="{{ route('admin.slider.status', $slider->id) }}" method="post">
                                                @csrf
    ...
    <div class="modal fade" id="addmodal" tabindex="-1" role="dialog" data-backdrop="static"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Create Slider Image</h5>
