...
<head>
    ...
    <!-- Progressbar css link -->
    <link rel="stylesheet" href="{{ asset('backend') }}/assets/css/jquery.rprogessbar.min.css">
    ...
    <style>
        ...
        .modal .modal-header>button>.fa-close {
            color: #ffffff;
            font-size: 16px;
        }
...
<body id="kt_body"
    ...
    <div class="d-flex flex-column flex-root">
        ...
        <div class="d-flex flex-row flex-column-fluid page">
            <!--begin::Aside-->
            @include('backend.layout.include.aside')
            <!--end::Aside-->
            <!--begin::Wrapper-->
            ...
            <div class="d-flex align-items-center mt-5">
                ...
                <div class="d-flex flex-column">
                    ...
                    <div class="navi mt-2">
                        ...
                        @include('backend.layout.include.menu.logout')
                    </div>
                </div>
            </div>
            <!--end::Header-->
